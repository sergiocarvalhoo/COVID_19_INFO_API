...
export class CreateTables1628722773381 implements MigrationInterface {
    name = 'CreateTables1628722773381'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "Images" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "path" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        ...
        await queryRunner.query(`CREATE TABLE "Bulletin" ("confirmed" integer NOT NULL, "recovered" integer NOT NULL, "discarded" integer NOT NULL, "under_review" integer NOT NULL, "admitted" integer NOT NULL, "deaths" integer NOT NULL, "publication_date" datetime PRIMARY KEY NOT NULL, "authorRegistration" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_Images" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "path" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "FK_2d64b690d92c5ffcfd162cec31c" FOREIGN KEY ("id") REFERENCES "News" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_Images"("id", "path", "created_at", "updated_at") SELECT "id", "path", "created_at", "updated_at" FROM "Images"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_Bulletin" ("confirmed" integer NOT NULL, "recovered" integer NOT NULL, "discarded" integer NOT NULL, "under_review" integer NOT NULL, "admitted" integer NOT NULL, "deaths" integer NOT NULL, "publication_date" datetime PRIMARY KEY NOT NULL, "authorRegistration" varchar, CONSTRAINT "FK_3fe8aa622cc004fe882acc57513" FOREIGN KEY ("authorRegistration") REFERENCES "Administrators" ("registration") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_Bulletin"("confirmed", "recovered", "discarded", "under_review", "admitted", "deaths", "publication_date", "authorRegistration") SELECT "confirmed", "recovered", "discarded", "under_review", "admitted", "deaths", "publication_date", "authorRegistration" FROM "Bulletin"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Bulletin" ("confirmed" integer NOT NULL, "recovered" integer NOT NULL, "discarded" integer NOT NULL, "under_review" integer NOT NULL, "admitted" integer NOT NULL, "deaths" integer NOT NULL, "publication_date" datetime PRIMARY KEY NOT NULL, "authorRegistration" varchar)`);
        await queryRunner.query(`INSERT INTO "Bulletin"("confirmed", "recovered", "discarded", "under_review", "admitted", "deaths", "publication_date", "authorRegistration") SELECT "confirmed", "recovered", "discarded", "under_review", "admitted", "deaths", "publication_date", "authorRegistration" FROM "temporary_Bulletin"`);
        ...
        await queryRunner.query(`CREATE TABLE "Images" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "path" varchar NOT NULL, "created_at" datetime NOT NULL DEFAULT (datetime('now')), "updated_at" datetime NOT NULL DEFAULT (datetime('now')))`);
        await queryRunner.query(`INSERT INTO "Images"("id", "path", "created_at", "updated_at") SELECT "id", "path", "created_at", "updated_at" FROM "temporary_Images"`);
